...
1. Реализовать описанную модель и все стратегии поведения на Unity 2021.3.30 C# можно [найти здесь](https://unity.com/releases/editor/archive). Мы будем оценивать в первую очередь качество кода вашего решения.
